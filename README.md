...
| 12 | [drawio](https://github.com/jgraph/drawio-desktop) | 图表绘制工具（diagrams.net） | 🎨 开发工具 | 31.4.5 |
...
| 15 | [wake](https://github.com/iAmCorey/Wake) | AI agent 会话统一管理（浏览/搜索/恢复） | 🤖 AI 工具 | 0.8.1 |
...
| 20 | [magpie](https://github.com/yetone/magpie) | 多 agent 模型统一管理（托盘 / CLI 网关） | 🤖 AI 工具 | 0.1.24 |
