...
| # | 软件 | 说明 | 类别 |
|---|------|------|------|
| 1 | [context-menu-mgr-plus](https://github.com/PLFJY/ContextMenuMgr) | Windows 右键菜单管理 | 🛠 系统工具 |
| 2 | [usbtree](https://github.com/gnomeria/usbtree) | USB 设备拓扑可视化 | 🛠 系统工具 |
| 3 | [rssh](https://github.com/shihuili1218/rssh) | 跨平台 SSH 连接管理器 | 🌐 网络工具 |
| 4 | [linkcode](https://github.com/arcboxlabs/linkcode) | AI 编程代理统一工作台 | 🤖 AI 工具 |
| 5 | [deepseek-reasonix](https://github.com/esengine/DeepSeek-Reasonix) | AI 代码编辑器 | 🤖 AI 工具 |
| 6 | [open-design](https://github.com/nexu-io/open-design) | 设计和原型工具 | 🎨 开发工具 |
...
| 18 | [opencode](https://opencode.ai) | 开源 AI 编码 agent（v2 独立 CLI） | 🤖 AI 工具 |
